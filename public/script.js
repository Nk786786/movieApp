...
// ... Your TMDB related JavaScript code ...
...
// Function to display playlists and movies
function displayPlaylists() {
  ...
  // Update playlist options in the movie form
  const selectedPlaylistInput = document.getElementById('selectedPlaylistInput');
  selectedPlaylistInput.innerHTML = '';
  playlists.forEach(playlist => {
    const option = document.createElement('option');
    option.value = playlist.id;
    option.textContent = `${playlist.name} (${playlist.privacy})`;
    selectedPlaylistInput.appendChild(option);
  });
}

// Add event listener to the playlist form
const playlistForm = document.getElementById('playlistForm');
...
movieForm.addEventListener('submit', (e) => {
  ...
  const selectedPlaylistId = parseInt(document.getElementById('selectedPlaylistInput').value);
  addMovieToPlaylist(movieTitle, selectedPlaylistId);
});

// Call the function to initially display playlists and movies
displayPlaylists();
